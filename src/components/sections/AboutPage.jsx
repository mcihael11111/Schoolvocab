    ...
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "40px 24px 96px" }}>
        ...
        <div style={{ fontSize: 18, color: "#475569", lineHeight: 1.75, marginBottom: 64, maxWidth: 620, display: "flex", flexDirection: "column", gap: 20 }}>
          <p style={{ margin: 0 }}>
            Every subject has its own language — and teachers know immediately whether you know it or not. You can understand a concept perfectly and still lose marks because you didn't name it precisely, didn't use the right terminology, or couldn't explain why it matters.
          </p>
          <p style={{ margin: 0 }}>
            The problem isn't intelligence. It's exposure. Vocabulary is something you build through encounter — and SchoolVocab is designed to accelerate that. Terms across English, Mathematics, Science, History, and more — each explained clearly so the knowledge actually sticks.
          </p>
          <p style={{ margin: 0 }}>
            No textbooks, no flashcard apps that quiz you on definitions alone. Every term here comes with a plain-language definition, why it matters in context, a realistic scenario so you can see it in action, and related terms so the ideas connect instead of sitting in a list.
          </p>
        </div>
        ...
        <Section label="Why it exists">
          <p>
            There's a vocabulary gap in school that nobody talks about directly. Teachers assume you know certain terms. Textbooks use them without always explaining them. And in assessments, if you use vague language where precise language was expected — marks disappear.
          </p>
          <p>
            SchoolVocab is here to close that gap. Not with more notes, not with practice papers — just with the vocabulary itself, explained the way a good tutor would: clearly, with context, and with enough depth that you actually understand why the term matters.
          </p>
        </Section>
        ...
        <Section label="Who it's for">
          <p>
            Any student in Years 7 to 12 who wants to write with more precision and confidence. Specifically:
          </p>
          <p>
            You're studying Science and want to be sure you can distinguish mitosis from meiosis in a sentence teachers reward. You're in an English exam and reach for 'language technique' when you should be writing 'sibilance' or 'anaphora'. You're finishing a Maths unit and realise you've been using 'function' loosely when the concept has a precise definition that unlocks a higher mark.
          </p>
          <p>
        ...
        <Section label="What you'll find here">
          <p>
            Every term was selected because it appears in the Australian curriculum, syllabuses, marking guidelines, and teacher feedback — the words that come up in assessments, exams, and classroom discussions. Nothing obscure. Nothing purely theoretical. Just the vocabulary that actually shows up when it matters.
          </p>
          <p>
        ...
        <Section label="Who built this">
          <p>
            Hi — I'm Michael Papanikolaou, a designer and product person based in Australia. I built SchoolVocab because I kept noticing the same thing: students who understood the content were still being penalised for language that wasn't precise enough. The knowledge was there. The vocabulary wasn't.
          </p>
          <p>
            Language shouldn't be a gatekeeping thing. If you know the word, you can use it. And if you can use it precisely in an assessment, you can demonstrate understanding that a vague paraphrase never could. That's the whole idea behind this.
          </p>
